...
public class FhirCastWebsocketEndpoint {
    ...
    public void testFcSendEvent() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        stompSession.subscribe( SUBSCRIBE_FHIRCAST_EVENT_ENDPOINT + uuid+"/event", fhircastSendFrameHandler);
...
//        //////////////////////////////////////////////////////////////////////
        ...
        stompSession2.subscribe( SUBSCRIBE_FHIRCAST_EVENT_ENDPOINT + uuid+"/event", fhircastSendFrameHandler2);
        ...
        stompSession.send( SEND_FHIRCAST_EVENT_ENDPOINT + uuid+"/event", fhirCastEvent);
