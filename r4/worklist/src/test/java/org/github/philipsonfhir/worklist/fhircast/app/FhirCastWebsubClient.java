package org.github.philipsonfhir.worklist.fhircast.app;

import ca.uhn.fhir.context.FhirContext;
import org.github.philipsonfhir.worklist.fhircast.server.Prefix;
import org.github.philipsonfhir.worklist.fhircast.server.websub.domain.*;
...
public class FhirCastWebsubClient {
    ...
    public FhirCastWebsubClient(String url, String topicId) {
        this.baseUrl = url;
        this.topicUrl = url+"/"+ Prefix.FHIRCAST_TOPIC+"/"+topicId;
    ...
    public void close() {
        ...
        restTemplate.postForLocation( baseUrl+"/"+Prefix.FHIRCAST_WEBSUB+"/"+topicId, fhirCastWorkflowEvent );
    }
...
//        }
    ...
    public void getContext() {
        RestTemplate restTemplate =  new RestTemplate(  );
        FhirCastWorkflowEvent fhirCastWorkflowEvent = restTemplate.getForObject( baseUrl+"/"+Prefix.FHIRCAST_WEBSUB+"/"+topicId, FhirCastWorkflowEvent.class );
