...
public final class MyHapiWorkerContext implements IWorkerContext, ValueSetExpander, ValueSetExpanderFactory {
    ...
    public MyHapiWorkerContext(FhirContext theCtx, IValidationSupport theValidationSupport) {
        com.github.benmanes.caffeine.cache.Cache a;
